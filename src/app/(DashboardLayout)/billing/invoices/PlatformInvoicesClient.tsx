...
// ==============================================================================
// Platform Invoices Client Component
// ==============================================================================
// Displays subscription/platform invoices with pagination and status filters.
// ==============================================================================
...
import { getPlatformInvoices } from "@/app/actions/billing";
...
const PlatformInvoicesClient = () => {
  ...
  const fetchData = async () => {
    ...
    setError("");
    try {
      const result = await getPlatformInvoices({ page, perPage: 10, search });
      if ("error" in result) {
        ...
        <div className="overflow-x-auto">
          {loading ? (
            ...
            <div className="text-center py-12 text-gray-500">
              <Icon icon="solar:bill-list-line-duotone" height={48} className="mx-auto mb-3 opacity-50" />
              <p className="text-lg">No platform invoices found</p>
            </div>
          ) : (
            <Table hoverable>
              <TableHead>
              ...
              <TableBody className="divide-y">
                {invoices.map((inv: any) => (
                  <TableRow key={inv.id}>
                    ...
                    <TableCell>{inv.tenant?.company_name || "—"}</TableCell>
...
export default PlatformInvoicesClient;
