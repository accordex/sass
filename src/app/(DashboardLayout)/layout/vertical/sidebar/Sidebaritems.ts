...
const SidebarContent: MenuItem[] = [
  {
    ...
    items: [
            ...
            children: [
              {
                ...
                id: uniqueId(),
                url: "/accounting/payments/receipts",
              },
              {
                name: "Payments Made",
                id: uniqueId(),
                url: "/accounting/payments/made",
              },
            ],
          },
          {
            name: "Bank Accounts",
            icon: "solar:safe-2-line-duotone",
            id: uniqueId(),
      ...
      // ============================================================
      // Phase 3: HRMS — Human Resource Management
      // ============================================================
      {
        heading: "HRMS",
        children: [
            ...
            children: [
              {
                name: "Leave Types",
                id: uniqueId(),
                url: "/hrms/leave/types",
              },
              {
                name: "Leave Requests",
                id: uniqueId(),
                url: "/hrms/leave/requests",
              },
            ],
          },
          {
            name: "Holidays",
            icon: "solar:sun-fog-line-duotone",
            id: uniqueId(),
            url: "/hrms/holidays",
          },
        ],
      ...
      // ============================================================
      {
        ...
        children: [
          ...
          {
            name: "Payroll Runs",
            icon: "solar:calculator-minimalistic-line-duotone",
            id: uniqueId(),
            url: "/payroll/runs",
          },
          {
            name: "Payslips",
            icon: "solar:document-medicine-line-duotone",
            id: uniqueId(),
      ...
      // ============================================================
      {
        ...
        children: [
          ...
          },
          {
            ...
            id: uniqueId(),
            url: "/elearning/enrollments",
          },
          {
            name: "Certificates",
            icon: "solar:diploma-verified-line-duotone",
            id: uniqueId(),
            url: "/elearning/certificates",
          },
        ],
      },
