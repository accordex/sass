// ==============================================================================
// API Route: /api/v1/forum-posts — Forum Post Management
// ==============================================================================

import { NextRequest, NextResponse } from "next/server";
import { getForumPosts, createForumPost, updateForumPost, deleteForumPost } from "@/app/actions/elearning";
...
export async function POST(request: NextRequest) {
  ...
  const result = await createForumPost(body);
...
export async function PUT(request: NextRequest) {
  ...
  const body = await request.json();
  const result = await updateForumPost(id, body);
  if ("error" in result) return NextResponse.json({ error: result.error, details: (result as any).details }, { status: 400 });
  return NextResponse.json(result);
}
