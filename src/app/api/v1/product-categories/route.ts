// ==============================================================================
// API Route: /api/v1/product-categories — Product Category Management
// ==============================================================================
...
export async function GET(request: NextRequest) {
  ...
  const result = await getProductCategories({ search: searchParams.get("search") || "" });
...
export async function POST(request: NextRequest) {
  ...
  const result = await createProductCategory(body);
...
export async function PUT(request: NextRequest) {
  ...
  const body = await request.json();
  const result = await updateProductCategory(id, body);
  if ("error" in result) return NextResponse.json({ error: result.error, details: (result as any).details }, { status: 400 });
  return NextResponse.json(result);
}
