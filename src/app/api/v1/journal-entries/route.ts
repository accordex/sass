// ==============================================================================
// API Route: /api/v1/journal-entries — Journal Entry Management
// ==============================================================================

import { NextRequest, NextResponse } from "next/server";
import { getJournalEntries, createJournalEntry } from "@/app/actions/accounting";
...
export async function GET(request: NextRequest) {
  ...
  const result = await getJournalEntries({
    ...
    sortBy: searchParams.get("sort_by") || "entry_date",
