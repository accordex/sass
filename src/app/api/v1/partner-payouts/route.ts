// ==============================================================================
// API Route: /api/v1/partner-payouts — Partner Payout Management
// ==============================================================================

import { NextRequest, NextResponse } from "next/server";
import { getPayouts, createPayout, updatePayout, deletePayout } from "@/app/actions/partner";
...
export async function POST(request: NextRequest) {
  ...
  const result = await createPayout(body);
...
export async function PUT(request: NextRequest) {
  ...
  const body = await request.json();
  const result = await updatePayout(id, body);
  if ("error" in result) return NextResponse.json({ error: result.error, details: (result as any).details }, { status: 400 });
  return NextResponse.json(result);
}
